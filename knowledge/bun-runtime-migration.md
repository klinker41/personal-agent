...
updated_at: 2026-09-10T00:01:32.560183+00:00
confidence: 0.95
---
...
- Bun's Jest compatibility layer does not support `jest.mock('fs')`; use
`jest.spyOn(fs, ...)` instead when mocking filesystem functions in test suites.
