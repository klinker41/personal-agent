...
updated_at: 2026-09-26T00:32:43.403855+00:00
confidence: 1.0
---
...
- **Coding & Subagents:** Subagents for coding/tests use `Model: "flash"`
  (`rules/coding-subagent-model.md`). All rule/skill names must be kebab-case.
...
- **Pipeline & Lifecycle:** Turn-1 injection (`hooks/inject_memory.py`) triggers
  on `initialNumSteps == 0` and `invocationNum == 1`. Nightly schedule:
