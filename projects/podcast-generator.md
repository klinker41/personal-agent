...
updated_at: 2026-09-25T00:33:40.107265+00:00
confidence: 0.95
---
...
- **Single-Container Runtime**: Consolidated legacy services (Postgres, Redis,
  ...
  Runs Bun, Hono, and FFmpeg for React SPA, REST APIs, streaming, and movie
...
- **Generation & Ad Placement**: Synthesizes episodes via Gemini (`TEXT_MODEL`,
  `IMAGE_MODEL`, `AUDIO_MODEL` for script, 1:1 cover art, multi-speaker TTS)
  and FFmpeg ID3v2 tagging. Evenly distributes optional ad reads (`ad_reads?:
  string[] | null` from `PodcastForm.tsx` / `podcasts.ts`) across dialogue at
